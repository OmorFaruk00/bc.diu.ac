    ...
    <div class="container py-5">
      <form @submit.prevent="login()" @keydown="form.onKeydown($event)">
        <div class="row">
          ...
          <div class="col-lg-12">
            <h6 class="text-info">***<b>Payments:</b> bKash/Nagad : <a href="tel:01736121557">01753818503</a> (Mohammad Shafaet Hossain - Treasurer DIU BC)</h6>
          </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
              <label for="linkedin_url">Linkedin Url (If Any)</label>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
              <label for="computer_sector">Preferred Area of Contribution</label>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
              <label for="part_cpc">Why do want be a part of DIU BC ?</label>
              <textarea v-model="form.part_cpc" name="part_cpc" id="why" class="form-control" cols="30" rows="2"
                        placeholder="Enter why do want be a part of DIU BC"></textarea>
...
export default {
  ...
  data: () => ({
    ...
    expertise: [],
    skill: [
      {item: 'Business idea and innovation', name: 'Business idea and innovation'},
      {item: 'Cultural Activities', name: 'Cultural Activities'},
      {item: 'Social welfare activites', name: 'Social welfare activites'},
      {item: 'Sports Activities', name: 'Sports Activities'},
      {item: 'Women welfare', name: 'Women welfare'},
      {item: 'Other', name: 'Other(Specify)'},
    ...
    url: 'https://bcadmin.diu.ac/api/v1/',
